...
public class
ItemDAO implements DAO<Item, Integer>{

    private MyConnection connection = null;

    public ItemDAO(MyPostgresConnection connection) {
        if(connection != null) {
    ...
    public boolean save(Item item) {
        String saveStatement = "INSERT INTO " + connection.getDefaultSchema() + "." + "item"
                + " (itemname, itemdescription) VALUES (?,?) returning itemid";
        try (Connection connection = MyPostgresConnection.getConnection();
