...
public class StockInventoryDAO implements DAO<Item, Integer>{
    ...
    public boolean update(Item item) {
        String updateStatement = "UPDATE " + connect.getDefaultSchema()
                + ".stock_inventory SET item_name = ?, item_quantity = ?, item_price = ? where item_id = ?";
    ...
    public boolean save(Item item) {
        String saveStatement = "INSERT INTO " + connect.getDefaultSchema() + "." + "stock_inventory"
                + " (item_name, item_quantity, item_price) VALUES (?,?,?) returning item_id";
        try (Connection connection = connect.getConnection();
    ...
    public List retrieveAll() {
        String selectStatement = "SELECT * FROM " + connect.getDefaultSchema() + "." + "stock_inventory";
